...
// но.
// const _Distance = prompt('Пожалуйста, введите расстояние в км между двумя городами');
// const _HOURS_OF_TRAVEL = prompt('Укажите за сколько часов вы хотите добраться до места назначения')
// let travelSpeed = _Distance / _HOURS_OF_TRAVEL;
// alert( 'Для того что бы вовремя добраться до места назначения, вам нужно двигаться со скорость: ' + travelSpeed + ' км/час' );
...
// const _AMOUNT = prompt('Введите количество долларов для конвертации в евро')
...
// флешку.
// const _CAPACITY_USB = prompt('Введите объём флешки')
// const _FILE = 820
...
// ся.
// const _MONEY = prompt("Сколько денег у вас есть?");
// const _СHOCOLATE = prompt("Стоимость 1 шоколадки:");
...
// const _NUMBER  = prompt('Введите целое число')
